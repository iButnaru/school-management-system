        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="treeview {{ ($prefix == '/setups') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{ route('subject.view') }}"><i class="ti-more"></i>Subject</a>
                    <li><a href="{{ route('assign.subject.view') }}"><i class="ti-more"></i>Assign Subject</a>
                    <li><a href="{{ route('designation.view') }}"><i class="ti-more"></i>Designation</a>
                    </li>
                </ul>
            </li>
            ...
            <li class="treeview {{ ($prefix == '/students') ? 'active' : '' }}">
                ...
                <ul class="treeview-menu">
                    <li><a href="{{ route('student.assignation.view') }}"><i class="ti-more"></i>Student
                            Registration</a></li>

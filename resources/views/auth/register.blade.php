                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="text" id="name" name="name" class="form-control pl-15 bg-transparent text-white plc-white" value="{{ old('name') }}" placeholder="Full Name">
									</div>
								</div>
								<div class="form-group">
                                    @error('email')
								...
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="password" name="password" id="password" value="{{ old('password') }}" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Password">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="input-group mb-3">
										...
										<input type="password" id="password_confirmation" name="password_confirmation" value="{{ old('password_confirmation') }}" class="form-control pl-15 bg-transparent text-white plc-white" placeholder="Retype Password">
									</div>
								</div>
								  <div class="row">
									<div class="col-12">
